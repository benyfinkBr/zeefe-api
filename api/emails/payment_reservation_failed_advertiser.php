        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#B54A3A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:16px;letter-spacing:0.12em;color:#FCEDEA;text-transform:uppercase;">Atenção</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#FFF4EF;">Pagamento não aprovado</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Não conseguimos aprovar o pagamento da reserva abaixo. O cliente tem 15 minutos para atualizar o método de pagamento. Caso contrário, a reserva corre o risco de não ser confirmada.</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0;border-collapse:collapse;">
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;font-weight:600;">Motivo</td>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{motivo}}</td>
                </tr>
              </table>
              <p style="margin:0 0 18px;font-size:15px;line-height:1.5;">Acompanhe pelo Portal do Anunciante e, se necessário, entre em contato com o cliente para ajudá-lo a atualizar o cartão.</p>
