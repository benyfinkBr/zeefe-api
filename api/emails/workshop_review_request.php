...
<head>
  <meta charset="UTF-8" />
  <title>Avalie seu workshop — Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#1D413A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:15px;letter-spacing:0.1em;color:#E6DED4;text-transform:uppercase;">Sua opinião importa</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#F5F0E9;">Olá, {{participant_name}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Obrigado por participar do workshop <strong>{{workshop_title}}</strong>.</p>
              <p style="font-size:15px;line-height:1.6;margin:18px 0;">Queremos ouvir você: avalie o evento e a plataforma em poucos minutos.</p>
              <div style="text-align:center;margin:24px 0;">
                <a href="{{review_url}}" style="display:inline-block;background:#1D413A;color:#F5F0E9;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Avaliar agora</a>
              </div>
            </td>
          </tr>
          <tr>
