...
<head>
  <meta charset="UTF-8" />
  <title>Link de gestão do workshop — Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#1D413A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:15px;letter-spacing:0.1em;color:#E6DED4;text-transform:uppercase;">Gestão de workshop</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#F5F0E9;">{{workshop_title}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Use o link abaixo para abrir o painel de convidados já filtrado para este evento.</p>
              <div style="text-align:center;margin:24px 0;">
                <a href="{{manage_url}}" style="display:inline-block;background:#1D413A;color:#F5F0E9;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Abrir gestão do evento</a>
              </div>
              <p style="margin:0;font-size:14px;color:#8A7766;">Este link direciona para o login e, após a autenticação, abre automaticamente o workshop correto.</p>
            </td>
          </tr>
          <tr>
