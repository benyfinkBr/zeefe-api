...
<head>
  <meta charset="UTF-8" />
  <title>Workshop cancelado — Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#1D413A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:15px;letter-spacing:0.1em;color:#E6DED4;text-transform:uppercase;">Workshop cancelado</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#F5F0E9;">Olá, {{participant_name}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">O workshop abaixo foi cancelado:</p>
              ...
              <p style="font-size:15px;line-height:1.6;margin:18px 0;">{{refund_note}}</p>
              <p style="margin:0;font-size:14px;color:#8A7766;">Se precisar de ajuda, fale com nosso suporte.</p>
            </td>
          </tr>
          <tr>
