...
<head>
  <meta charset="UTF-8" />
  <title>Detalhes da reserva - Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#1D413A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:15px;letter-spacing:0.1em;color:#E6DED4;text-transform:uppercase;">Dados da reserva</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#F5F0E9;">Olá, {{cliente_nome}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Pagamento confirmado! Seguem os detalhes para compartilhar com o seu time e convidados.</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;border-collapse:collapse;">
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;font-weight:600;">Endereço</td>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{endereco}}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;font-weight:600;">Código da reserva</td>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{codigo_publico}}</td>
                </tr>
              </table>
              <p style="margin:0 0 18px;font-size:15px;line-height:1.6;">
                Use o Portal do Cliente para adicionar visitantes, enviar convites com calendário e acompanhar atualizações da reserva.
              </p>
              <div style="text-align:center;margin:28px 0;">
                <a href="{{link_portal}}" style="display:inline-block;background:#1D413A;color:#F5F0E9;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Gerenciar reserva</a>
              </div>
              <p style="margin:0;font-size:14px;color:#8A7766;">Precisa de suporte? Responda este e-mail ou nos chame pelo contato@zeefe.com.br.</p>
            </td>
          </tr>
          <tr>
