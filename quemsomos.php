  ...
  <main>
    <section class="landing-section">
      <div class="section-heading">
        <h3>Quem somos</h3>
        <p>Uma plataforma criada para facilitar encontros presenciais de empresas, times e profissionais independentes.</p>
      </div>
      <p>A Ze.EFE conecta quem precisa de espaços acolhedores e bem equipados com quem já tem salas prontas para uso. Nosso foco é simplificar todo o fluxo, da pré-reserva ao check-in.</p>
    </section>
  </main>
