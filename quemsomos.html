    ...
    <div class="site-header-inner">
      <div class="site-header-left">
        ...
        <nav class="site-nav">
          ...
          <a href="quemsomos.html" aria-current="page">Quem somos</a>
        </nav>
      </div>
  ...
  <main>
    <section class="landing-section">
      <div class="section-heading">
        <h3>Quem somos</h3>
        <p>A Ze.EFE e uma plataforma inovadora que facilita encontros presenciais e colaborativos.</p>
      </div>
      <p><strong>O que fazemos:</strong> conectamos quem precisa de espacos com quem oferece ambientes prontos para uso imediato, com uma experiencia simples, agil e transparente do inicio ao fim.</p>
      <p><strong>Nossa missao:</strong> aproximar pessoas e empresas de espacos de qualidade, com praticidade e confianca, tornando o acesso mais facil e acessivel.</p>
      <p><strong>Para quem e:</strong> empreendedores, empresas, times e profissionais independentes que buscam espacos versateis para reunioes, workshops, cursos e eventos colaborativos.</p>
    </section>
  </main>
