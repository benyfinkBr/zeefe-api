...
<head>
  <meta charset="UTF-8" />
  <title>Pagamento confirmado — Workshop Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          ...
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Pagamento confirmado! Seu lugar está garantido no curso abaixo:</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;border-collapse:collapse;">
                <tr>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;width:35%;font-weight:600;">Curso</td>
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{curso_nome}}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{horario}}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding:10px 0;border-bottom:1px solid #E6DED4;">{{codigo_ingresso}}</td>
                </tr>
              </table>
              <p style="font-size:15px;line-height:1.6;margin:18px 0;">
                Utilize o QR Code abaixo para validar sua presença no dia do evento.
              </p>
              <div style="text-align:center;margin:24px 0;">
                <a href="{{checkin_url}}" style="display:inline-block;background:#1D413A;color:#F5F0E9;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Abrir QR Code</a>
              </div>
              <div style="text-align:center;margin:18px 0;color:#8A7766;font-size:14px;">
                <p style="margin:0;">Você também pode acompanhar os detalhes pelo portal.</p>
                <a href="{{link_portal}}" style="color:#1D413A;text-decoration:none;font-weight:600;">Acessar Portal do Cliente</a>
              </div>
            </td>
          </tr>
          <tr>
