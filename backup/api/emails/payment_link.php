...
<head>
  <meta charset="UTF-8" />
  <title>Finalize seu pagamento - Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#1D413A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:16px;letter-spacing:0.12em;color:#E6DED4;text-transform:uppercase;">Próximo passo</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#F5F0E9;">Olá, {{cliente_nome}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Recebemos sua solicitação de reserva! Para garantir o espaço, finalize o pagamento usando o link abaixo.</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:24px 0;border-collapse:collapse;">
                ...
                <tr>
                  ...
                  <td style="padding:12px 0;border-bottom:1px solid #E6DED4;">{{horario}}</td>
                </tr>
              </table>
              <div style="text-align:center;margin:32px 0;">
                <a href="{{link_pagamento}}" style="display:inline-block;background:#D97A1C;color:#FFFFFF;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Finalizar pagamento</a>
              </div>
              <p style="margin:0;font-size:14px;color:#8A7766;">Se já realizou o pagamento, desconsidere esta mensagem. Em caso de dúvidas, responda este e-mail ou fale conosco pelo contato@zeefe.com.br.</p>
            </td>
          </tr>
          <tr>
