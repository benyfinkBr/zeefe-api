...
<head>
  <meta charset="UTF-8" />
  <title>Pagamento não aprovado - Ze.EFE</title>
</head>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#FFFFFF;border-radius:24px;box-shadow:0 12px 32px rgba(29,65,58,0.12);overflow:hidden;">
          <tr>
            <td style="background:#B54A3A;padding:32px;text-align:center;">
              ...
              <p style="margin:0;font-size:16px;letter-spacing:0.12em;color:#FCEDEA;text-transform:uppercase;">Pagamento não aprovado</p>
              <h1 style="margin:12px 0 0;font-size:26px;color:#FFF4EF;">Olá, {{cliente_nome}}</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px;">
              <p style="margin-top:0;font-size:16px;line-height:1.6;">Não conseguimos aprovar o pagamento da sua reserva.</p>
              <p style="margin:0 0 12px;font-size:15px;line-height:1.5;color:#8A7766;">Motivo informado: <strong>{{motivo}}</strong></p>
              <p style="margin:0 0 12px;font-size:15px;line-height:1.5;">Você tem até 15 minutos para atualizar o método de pagamento; caso contrário, a reserva poderá ser cancelada automaticamente.</p>
              ...
              <p style="margin:0 0 18px;font-size:15px;line-height:1.5;">Acesse o portal para cadastrar um novo método de pagamento ou tentar novamente.</p>
              <div style="text-align:center;margin:28px 0;">
                <a href="{{link_portal}}" style="display:inline-block;background:#1D413A;color:#F5F0E9;text-decoration:none;padding:14px 26px;border-radius:12px;font-weight:600;">Ir para o Portal</a>
              </div>
              <p style="margin:0;font-size:14px;color:#8A7766;">Se tiver dúvidas, fale com nosso time pelo contato@zeefe.com.br.</p>
            </td>
          </tr>
          <tr>
